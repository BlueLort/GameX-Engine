...
namespace gx {
	...
	public:
		...
		void init(const GXVec3& position = GXVec3(0.0f, 0.0f, 0.0f), const GXVec3& up = GXVec3(0.0f, 1.0f, 0.0f), float yaw = YAW, float pitch = PITCH, float AR=ASPECT_RATIO, float zNear=zNEAR, float zFar=zFAR);
