	...
	public:
		...
		static double noise(double x, double y, double z) {
			...
			return GXMaths::lerp(w, GXMaths::lerp(v, GXMaths::lerp(u, grad(p[AA], x, y, z),  // AND ADD
				...
				GXMaths::lerp(u, grad(p[AB], x, y - 1, z),  // RESULTS
					grad(p[BB], x - 1, y - 1, z))),// FROM  8
				GXMaths::lerp(v, GXMaths::lerp(u, grad(p[AA + 1], x, y, z - 1),  // CORNERS
					grad(p[BA + 1], x - 1, y, z - 1)), // OF CUBE
					GXMaths::lerp(u, grad(p[AB + 1], x, y - 1, z - 1),
